...
import com.example.myapplication.achatsenvoi.DialogCinquante
import com.example.myapplication.achatsenvoi.DialogConfirm
import com.example.myapplication.achatsenvoi.SendTicket
import com.example.myapplication.data.Compte
...
//                sayHello("Bearer "+sharedPreferences.getString("token", null).toString())
            ...
            3 -> {
                ...
                startActivity(Intent(this, com.example.myapplication.view.Menu::class.java))
                return true
            }
            ...
            4 -> {
                ...
                println("${sharedPreferences.getString("token", null).toString()}")
    ...
    fun getCompte(token: String, id: Int) {
        ...
        call.enqueue(object : Callback<Compte> {
            override fun onResponse(call: Call<Compte>, response: Response<Compte>) {
                if(response.body()?.nbr_ticket_cent != null){
