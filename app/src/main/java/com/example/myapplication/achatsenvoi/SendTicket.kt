package com.example.myapplication.achatsenvoi
...
import com.example.myapplication.data.DataSendTicket
...
class SendTicket : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val mediaPlayer = MediaPlayer.create(activity, R.raw.touch)
